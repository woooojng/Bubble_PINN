...
def lossNSpde(net, x, y, t):
    ...
    rho = net.rho(x,y,t)
    J1, J2 = net.J(x,y,t)
    nabula_cdot_etatau1, nabula_cdot_etatau2 = net.nabula_cdot_etatau(x,y,t)
    ...
    LHS5_xcoord = nabula_cdot_etatau1
    LHS5_ycoord = nabula_cdot_etatau2
...
def DivLoss(net, x, y, t):
    ...
    DivLoss = mse_cost_function(div, zero)
