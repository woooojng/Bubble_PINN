...
def lossNSpde(net, x, y, t):
    ...
    NSpde_loss = (mse_cost_function(NSpde_xcoord, zero_NSpde_xcoord) + mse_cost_function(NSpde_ycoord, zero_NSpde_ycoord))
    NSpde_div_loss = (mse_cost_function(NSpde_div_xcoord, zero_NSpde_div_xcoord) + mse_cost_function(NSpde_div_ycoord, zero_NSpde_div_ycoord))
